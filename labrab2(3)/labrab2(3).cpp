...
void getPos(player& player) { std::cout << "Позиция игрока - " << player.return_position(); };
int stat(team& tm)
{
    int points;
    try
